...
class OrganizationUnitType extends SuperEntity{
    ...
    function selectDefault($idFromCreate = -1 ){
        ...
        $select.= "(select count(*) From Org_Tree as Tree where Tree.OrgUnitType_FK = Typ.Id) as HasUnits, ";
        $select.= "(select count(*) From Org_Tree as Tree inner join Org_Pos as Pos On Tree.Id=Pos.OrgTree_FK where Tree.OrgUnitType_FK = Typ.Id) as HasPos, ";
