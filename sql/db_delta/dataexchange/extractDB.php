...
define("SALT_PREFIX", "|SLT|"); // FROM CONFIG
...
$listResult1 = $db->reportQuery(SQL_STAR_PEOPLE . " from People");
    $listRowsP = array();
    $pCols = 27;
...
$listResult2 = $db->reportQuery(SQL_STAR_HOMES . " from Homes");
    $pCols = 9;
